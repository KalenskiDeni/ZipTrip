  ...
  return (
    <section className="post-detail-page">
      <header className="detail-header">
        ...
        />
        <h2>{`${pickupLocation || "Unknown Pickup"} - ${
          dropoffLocation || "Unknown Dropoff"
        }`}</h2>
      </header>
      ...
      <div className="ride-summary">
        ...
        <div className="ride-times">
          <div>
            <p className="time">
              {post.departureTime || "Unknown Departure Time"}
            </p>
      ...
      <div className="details-section">
        ...
        <div className="details-item">
          ...
          <div>
            ...
            <p>
              {details.detour ||
                "The driver is willing to make a 5 min. detour"}
            </p>
          </div>
        </div>
        ...
        <div className="details-item">
          ...
          <div>
            ...
            <p>
              {details.comfort ||
                "Driver guarantees a maximum of 2 passengers in the back seat"}
            </p>
          </div>
        </div>
        ...
        <div className="details-item">
          ...
          <div>
            ...
            <p>
              {details.booking ||
                "Book instantly without waiting for driver confirmation"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="environment-section">
        ...
        <ul>
          <li>
            ...
            {environmentalBenefits.co2 || 89} kg CO2 saved
          </li>
          <li>
            <img src={airIcon} alt="Clean Air Icon" />{" "}
            {environmentalBenefits.cleanAir || 9}% clean air
          </li>
          <li>
            <img src={gasIcon} alt="Gas Icon" />{" "}
            {environmentalBenefits.gas || 13} gallons of gas saved
          </li>
          <li>
            <img src={treeIcon} alt="Tree Icon" />{" "}
            {environmentalBenefits.trees || 1.5} trees saved
          </li>
        </ul>
      </div>
